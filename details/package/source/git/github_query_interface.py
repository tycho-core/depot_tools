...
class GitHubQueryInterface(ProviderQueryInterface):
    ...
    class Project(ProjectBase):
        ...
        def __init__(self, owner, repo):
            """ Constructor """
            super(GitHubQueryInterface.Project,
                  self).__init__(owner, repo.name)
            self.__repo = repo
    ...
    class Version(VersionBase):
        ...
        def __init__(self, project, branch):
            """ Constructor """
            super(GitHubQueryInterface.Version, self).__init__(
                project, branch.name)
    ...
    def __init__(self, context, params):
        ...
        # self.__git_hub = Github(
        #     login_or_token=self.__auth_token, base_url=self.__base_url)
